...
| A-013 | A real bounded release programme can harden the surviving method better than further miniature architecture experiments | survives; consolidation now points to review/release | Cross-batch consolidation reconciles 41 unique targets. Post-R1 subject research contains 17 rows: 12 researched-internal and 5 under review, with 0 independent review. Exact source overlap is limited but non-zero. The next justified mode is cumulative review/release rather than more intake. | Freeze the 17 post-R1 subject-research rows for one internal review tranche; admit no new cases until that review closes. |
