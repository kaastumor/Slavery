...
| A-010 | The value of the flat coverage corpus compounds faster than review/update burden as it scales | active experiment / unresolved | COV-002/#151 tests 25→31→37 rows, full vs compact vs ordinary artifacts, information loss and six deterministic maintenance shocks. |
...
| V-014 | Does corpus reuse value grow faster than research/review/update burden, and can a compact register preserve the gain? | **ACTIVE / untested** | COV-002 is preregistered with a deterministic 12-cell expansion, F/R/M comparison and maintenance shocks. | Do not infer value from row count; sample freeze precedes research. |
