...
| A-011 | Tiering breadth, compact evidence and selective depth can make systematic coverage methodologically viable without default deep research for every target | active experiment / unresolved | COV-003/#155 freezes 24 C0 targets, 12 C1 targets, <=3 C2 escalations and tests batch source reuse, QA value and versioned maintenance. |
...
| V-016 | Can a C0/C1/C2 tiered, batch-curated, versioned architecture improve the systematic-coverage case? | **ACTIVE / untested** | COV-003/#155; deterministic sample and setup adversary frozen before new slavery research. | No credit for more rows; must demonstrate preserved uncertainty/provenance plus structural research/reuse value. |
