...
6. **REVISE — #122 — M2 integrated adversarial gate** (integration attack found inverse-mutation and chosen-provenance gaps; gate remains open)
7. **NOW — #136 — M2 corrective: close semantic invariant and chosen-geometry provenance gaps**
8. **GATE — #123 AUTO READY — M2 Project Health Check and reconciliation** (blocked until #136 correction + #122 re-attack complete)
