-- Disposable D-054 full-state release bundle integration fixture.
insert into atlas.source(
    source_id,title,author_or_institution,source_type,source_classification,notes
) values (
    '11111111-1111-4111-8111-111111111111'::uuid,
    'D-054 fixture source','CI','fixture','primary','Disposable bundle fixture'
);
...
insert into atlas.geometry(
    ...
    -100,-50,
    '22222222-2222-4222-8222-222222222222'::uuid,
    'fixture-geometry','fixture','specialist',
...
insert into atlas.claim(
    ...
    'D-054 full-state bundle integration fixture',
...
insert into cartography.land_fabric(
    ...
    'd054-bundle-fixture-land','D-054 fixture land','fixture-v1',
